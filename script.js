document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "....." },
        { time: 1, text: "You're my water when i'm stuck in the dessert" },
        { time: 4, text: "You're the tylenol  i take when my head hurts" },
        { time: 8, text: "You're the sunshine on my life" },
        { time: 14, text: "I just wanna see how beautiful you are" },
        { time: 21, text: "You know that i see it, i know you're a star" },
        { time: 27, text: "Where you go i'll follow no matter how far" },
        { time: 33, text: "If life  is a movie then you're the best part" },
        { time: 40, text: "O-o-o-oh" },
        { time: 43, text: "Your the best part " },
        { time: 46, text: "O-o-o-oh" },
    ];
